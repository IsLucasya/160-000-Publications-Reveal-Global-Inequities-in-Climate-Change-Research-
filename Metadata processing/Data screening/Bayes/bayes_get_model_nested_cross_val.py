...
results_df.to_csv('nested_cross_validation_results_nb.csv', index=False)
print("\u7ed3\u679c\u5df2\u4fdd\u5b58\u5230 nested_cross_validation_results_nb.csv")

# 保存模型
import joblib
joblib.dump(grid_search.best_estimator_, 'best_model_nb.pkl')
