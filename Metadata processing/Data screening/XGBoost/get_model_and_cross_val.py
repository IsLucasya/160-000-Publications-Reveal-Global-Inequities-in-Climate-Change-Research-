...
# 数据加载和预处理
training_data = pd.read_csv('气候适应-样本相关性训练集.csv')
...
results_df.to_csv('nested_cross_validation_results_xgb.csv', index=False)
print("\u7ed3\u679c\u5df2\u4fdd\u5b58\u5230 nested_cross_validation_results_xgb.csv")

# 保存模型
import joblib
joblib.dump(grid_search.best_estimator_, 'best_model_xgb.pkl')
